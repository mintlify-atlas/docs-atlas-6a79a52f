...
<CardGroup cols={2}>
  <Card title="generate_trajectory.py" icon="route" href="/simulation/dynamic-obstacles">
  ...
  <Card title="generate_flat_trajectory.py" icon="arrows-left-right" href="/simulation/dynamic-obstacles">
