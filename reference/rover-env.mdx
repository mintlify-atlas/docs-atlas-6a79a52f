---
title: "RoverEnv Gymnasium Environment API Reference Guide"
sidebarTitle: "RoverEnv"
description: "Complete API reference for RoverEnv — the LIDAR, IMU, and pose-based Gymnasium environment for rover navigation training in RoboTerrain simulations."
---
...
```
Applied when any LIDAR reading drops below **0.3 m** (`collision_threshold`). The episode does _not_ terminate on a single collision; persistent collision over `collision_window` steps triggers the general penalty instead.
