...
description: "Build and run the RoboTerrain Docker container based on osrf/ros:humble-desktop with Gazebo Fortress, PyTorch CUDA, and Stable Baselines3 pre-installed."
---
...
5. Install PyTorch (CUDA 11.8) and Stable Baselines3 via `pip3`
6. Copy the `ros2_ws/src/` directory into the image and run `colcon build`
...
- `gym==0.23.1` — OpenAI Gym (pinned for SB3 compatibility)
