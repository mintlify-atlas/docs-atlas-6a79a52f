...
description: "Clone RoboTerrain, build the ROS 2 workspace with colcon, launch Gazebo Fortress, and run your first SAC navigation agent in under 15 minutes."
---
